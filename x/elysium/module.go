...
// RandomizedParams creates randomized elysium param changes for the simulator.
func (AppModule) RandomizedParams(r *rand.Rand) []simtypes.ParamChange {
	return nil
}

// RegisterStoreDecoder registers a decoder for elysium module's types
...
// GenerateGenesisState creates a randomized GenState of the elysium module.
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	simulation.RandomizedGenState(simState)
}

// WeightedOperations returns the all the elysium module operations with their respective weights.
