...
func Test_IsValidIBCDenom(t *testing.T) {
	tests := []struct {
		...
		{"correct IBC denom", IbcElyDenomDefaultValue, true},
	}
...
func Test_IsValidElysiumDenom(t *testing.T) {
	tests := []struct {
		name    string
		denom   string
		success bool
	}{
		{"wrong length", "elysium0x/6B5A664BF0AF4F71B2F0BAA33141E2F1321242FBD", false},
		{"invalid denom", "aaa0xb7a4F3E9097C08dA09517b5aB877F7a917224ede", false},
		{"correct elysium denom", "elysium0xb7a4F3E9097C08dA09517b5aB877F7a917224ede", true},
	}
	for _, tt := range tests {
		tt := tt
		t.Run(tt.name, func(t *testing.T) {
			require.Equal(t, tt.success, IsValidElysiumDenom(tt.denom))
		})
	}
}
