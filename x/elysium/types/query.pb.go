...
func init() {
	proto.RegisterType((*ContractByDenomRequest)(nil), "elysium.ContractByDenomRequest")
	proto.RegisterType((*ContractByDenomResponse)(nil), "elysium.ContractByDenomResponse")
	proto.RegisterType((*DenomByContractRequest)(nil), "elysium.DenomByContractRequest")
	proto.RegisterType((*DenomByContractResponse)(nil), "elysium.DenomByContractResponse")
	proto.RegisterType((*ReplayBlockRequest)(nil), "elysium.ReplayBlockRequest")
	proto.RegisterType((*ReplayBlockResponse)(nil), "elysium.ReplayBlockResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "elysium.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "elysium.QueryParamsResponse")
	proto.RegisterType((*QueryPermissionsRequest)(nil), "elysium.QueryPermissionsRequest")
	proto.RegisterType((*QueryPermissionsResponse)(nil), "elysium.QueryPermissionsResponse")
}

func init() { proto.RegisterFile("elysium/query.proto", fileDescriptor_d4ed0fd688c48372) }
...
func (c *queryClient) ContractByDenom(ctx context.Context, in *ContractByDenomRequest, opts ...grpc.CallOption) (*ContractByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Query/ContractByDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomByContract(ctx context.Context, in *DenomByContractRequest, opts ...grpc.CallOption) (*DenomByContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Query/DenomByContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ReplayBlock(ctx context.Context, in *ReplayBlockRequest, opts ...grpc.CallOption) (*ReplayBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Query/ReplayBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Permissions(ctx context.Context, in *QueryPermissionsRequest, opts ...grpc.CallOption) (*QueryPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Query/Permissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ContractByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Query/ContractByDenom",
	}
...
func _Query_DenomByContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Query/DenomByContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ReplayBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Query/ReplayBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Permissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Query/Permissions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
