...
// MsgTransferTokens represents a message to transfer elysium evm coins through
// ibc.
...
// MsgUpdateParams defines the request type for updating elysium params.
...
// MsgUpdatePermissions defines the request type for updating elysium permissions.
...
func init() {
	proto.RegisterType((*MsgConvertVouchers)(nil), "elysium.MsgConvertVouchers")
	proto.RegisterType((*MsgTransferTokens)(nil), "elysium.MsgTransferTokens")
	proto.RegisterType((*MsgConvertVouchersResponse)(nil), "elysium.MsgConvertVouchersResponse")
	proto.RegisterType((*MsgTransferTokensResponse)(nil), "elysium.MsgTransferTokensResponse")
	proto.RegisterType((*MsgUpdateTokenMapping)(nil), "elysium.MsgUpdateTokenMapping")
	proto.RegisterType((*MsgUpdateTokenMappingResponse)(nil), "elysium.MsgUpdateTokenMappingResponse")
	proto.RegisterType((*MsgTurnBridge)(nil), "elysium.MsgTurnBridge")
	proto.RegisterType((*MsgTurnBridgeResponse)(nil), "elysium.MsgTurnBridgeResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "elysium.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "elysium.MsgUpdateParamsResponse")
	proto.RegisterType((*MsgUpdatePermissions)(nil), "elysium.MsgUpdatePermissions")
	proto.RegisterType((*MsgUpdatePermissionsResponse)(nil), "elysium.MsgUpdatePermissionsResponse")
}

func init() { proto.RegisterFile("elysium/tx.proto", fileDescriptor_28e09e4eabb18884) }
...
type MsgClient interface {
	// ConvertVouchers defines a method for converting ibc voucher to elysium evm
	// coins.
	ConvertVouchers(ctx context.Context, in *MsgConvertVouchers, opts ...grpc.CallOption) (*MsgConvertVouchersResponse, error)
	// TransferTokens defines a method to transfer elysium evm coins to another
	// chain through IBC
	...
	// UpdateParams defines a method to update elysium module params
	UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error)
	// UpdatePermissions defines a method to update elysium admins permissions
...
func (c *msgClient) ConvertVouchers(ctx context.Context, in *MsgConvertVouchers, opts ...grpc.CallOption) (*MsgConvertVouchersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Msg/ConvertVouchers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TransferTokens(ctx context.Context, in *MsgTransferTokens, opts ...grpc.CallOption) (*MsgTransferTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Msg/TransferTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateTokenMapping(ctx context.Context, in *MsgUpdateTokenMapping, opts ...grpc.CallOption) (*MsgUpdateTokenMappingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Msg/UpdateTokenMapping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TurnBridge(ctx context.Context, in *MsgTurnBridge, opts ...grpc.CallOption) (*MsgTurnBridgeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Msg/TurnBridge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePermissions(ctx context.Context, in *MsgUpdatePermissions, opts ...grpc.CallOption) (*MsgUpdatePermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.Msg/UpdatePermissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ConvertVouchers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Msg/ConvertVouchers",
	}
...
func _Msg_TransferTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Msg/TransferTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateTokenMapping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Msg/UpdateTokenMapping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_TurnBridge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Msg/TurnBridge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdatePermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.Msg/UpdatePermissions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
