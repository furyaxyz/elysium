...
type Params struct {
	IbcElyDenom string `protobuf:"bytes,1,opt,name=ibc_ely_denom,json=ibcElyDenom,proto3" json:"ibc_ely_denom,omitempty" yaml:"ibc_ely_denom,omitempty"`
	...
	ElysiumAdmin          string `protobuf:"bytes,3,opt,name=elysium_admin,json=elysiumAdmin,proto3" json:"elysium_admin,omitempty"`
...
func (m *Params) GetIbcElyDenom() string {
	if m != nil {
		return m.IbcElyDenom
	}
	return ""
}
...
func (m *Params) GetElysiumAdmin() string {
	if m != nil {
		return m.ElysiumAdmin
	}
	return ""
}
...
func init() {
	proto.RegisterType((*Params)(nil), "elysium.Params")
	proto.RegisterType((*TokenMappingChangeProposal)(nil), "elysium.TokenMappingChangeProposal")
	proto.RegisterType((*TokenMapping)(nil), "elysium.TokenMapping")
}

func init() { proto.RegisterFile("elysium/elysium.proto", fileDescriptor_8bc54992a93db2d2) }
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ElysiumAdmin) > 0 {
		i -= len(m.ElysiumAdmin)
		copy(dAtA[i:], m.ElysiumAdmin)
		i = encodeVarintElysium(dAtA, i, uint64(len(m.ElysiumAdmin)))
		i--
		dAtA[i] = 0x1a
	}
	if m.IbcTimeout != 0 {
		i = encodeVarintElysium(dAtA, i, uint64(m.IbcTimeout))
		i--
		dAtA[i] = 0x10
	}
	if len(m.IbcElyDenom) > 0 {
		i -= len(m.IbcElyDenom)
		copy(dAtA[i:], m.IbcElyDenom)
		i = encodeVarintElysium(dAtA, i, uint64(len(m.IbcElyDenom)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *TokenMappingChangeProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Decimal != 0 {
		i = encodeVarintElysium(dAtA, i, uint64(m.Decimal))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Symbol) > 0 {
		...
		i = encodeVarintElysium(dAtA, i, uint64(len(m.Symbol)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Contract) > 0 {
		...
		i = encodeVarintElysium(dAtA, i, uint64(len(m.Contract)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintElysium(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Description) > 0 {
		...
		i = encodeVarintElysium(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintElysium(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintElysium(dAtA []byte, offset int, v uint64) int {
	offset -= sovElysium(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Params) Size() (n int) {
	...
	l = len(m.IbcElyDenom)
	if l > 0 {
		n += 1 + l + sovElysium(uint64(l))
	}
	if m.IbcTimeout != 0 {
		n += 1 + sovElysium(uint64(m.IbcTimeout))
	}
	l = len(m.ElysiumAdmin)
	if l > 0 {
		n += 1 + l + sovElysium(uint64(l))
	}
	if m.EnableAutoDeployment {
...
func (m *TokenMappingChangeProposal) Size() (n int) {
	...
	if m.Decimal != 0 {
		n += 1 + sovElysium(uint64(m.Decimal))
	}
	return n
}
...
func sovElysium(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozElysium(x uint64) (n int) {
	return sovElysium(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IbcElyDenom", wireType)
			}
			...
			if intStringLen < 0 {
				return ErrInvalidLengthElysium
			}
			...
			m.IbcElyDenom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ElysiumAdmin", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ElysiumAdmin = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipElysium(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipElysium(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowElysium
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthElysium
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupElysium
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthElysium        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowElysium          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupElysium = fmt.Errorf("proto: unexpected end of group")
)
