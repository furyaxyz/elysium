...
func GetQueryCmd(queryRoute string) *cobra.Command {
	// Group elysium queries under a subcommand
	cmd := &cobra.Command{
...
func QueryParamsCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "params",
		Short: "Query the current elysium parameters",
		Args:  cobra.NoArgs,
		Long: strings.TrimSpace(`Query the current elysium parameters:

$ <appd> query elysium params
`),
