...
<div align="center">
  <h1> <img src="./assets/elysium.svg" alt="Elysium Logo" width="300px" /> </h1>
</div>
<br />

<p align="center">
  <a href="https://github.com/furyaxyz/elysium/actions/workflows/build.yml"><img label="Build Status" src="https://github.com/furyaxyz/elysium/actions/workflows/build.yml/badge.svg" /></a>
  <a href="https://codecov.io/gh/furyaxyz/elysium"><img label="Code Coverage" src="https://codecov.io/gh/furyaxyz/elysium/branch/main/graph/badge.svg" /></a>
  <a href="https://discord.gg/pahqHz26q4"><img label="Discord" src="https://img.shields.io/discord/783264383978569728.svg?color=7289da&label=Elysium&logo=discord&style=flat-square" /></a>
</p>
...
[Technical documentation](http://elysium.org/docs).
...
Please follow this [documentation](https://elysium.org/docs/getting-started/local-devnet.html#devnet-running-latest-development-node) to run a local devnet.

<a id="send-first-transaction" />

## 7. Send Your First Transaction

After setting the local devnet, you may interact with the your local blockchain by following this [documentation](https://elysium.org/docs/getting-started/local-devnet.html#interact-with-the-chain).
...
- [Project Website](http://elysium.org/)
- [Technical Documentation](http://elysium.org/docs)
- Community chatrooms (non-technical): [Discord](https://discord.gg/nsp9JTC) [Telegram](https://t.me/CryptoComOfficial)
- Developer community channel (technical): [![Support Server](https://img.shields.io/discord/783264383978569728.svg?color=7289da&label=Elysium&logo=discord&style=flat-square)](https://discord.gg/pahqHz26q4)
