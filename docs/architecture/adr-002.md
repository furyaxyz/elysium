...
Elysium#429 (https://github.com/furyaxyz/elysium/pull/429) bumps ibc-go dependency to v3.0.0 which include ICS30 middleware support.

Elysium#511(https://github.com/furyaxyz/elysium/pull/511) replaces the "hook" with a custom ICS30 middleware.
