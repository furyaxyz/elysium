...
func Setup(t *testing.T, elysiumAdmin string, skipGravity bool) *App {
	t.Helper()
	...
	return SetupWithGenesisValSet(t, elysiumAdmin, skipGravity, valSet, []authtypes.GenesisAccount{acc}, balance)
}
...
func SetupWithGenesisValSet(t *testing.T, elysiumAdmin string, skipGravity bool, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *App {
	t.Helper()

	app, genesisState := setup(true, skipGravity, 5)
	genesisState = genesisStateWithValSet(t, app, genesisState, valSet, genAccs, balances...)

	elysiumGen := elysiumtypes.DefaultGenesis()
	elysiumGen.Params.ElysiumAdmin = elysiumAdmin
	// enable auto deployment in test genesis
	elysiumGen.Params.EnableAutoDeployment = true
	genesisState["elysium"] = app.cdc.MustMarshalJSON(elysiumGen)
