...
import (
	...
	"github.com/furyaxyz/elysium/v2/app/ante"
	"github.com/furyaxyz/elysium/v2/x/elysium/middleware"
	...
	"github.com/furyaxyz/elysium/store/rootmulti"
	"github.com/furyaxyz/elysium/v2/x/elysium"
	elysiumclient "github.com/furyaxyz/elysium/v2/x/elysium/client"
	...
	elysiumtypes "github.com/furyaxyz/elysium/v2/x/elysium/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/furyaxyz/elysium/v2/client/docs/statik"
	...
	_ "github.com/furyaxyz/elysium/v2/x/elysium/rpc"
)
...
var (
	...
	maccPerms = map[string][]string{
		...
		elysiumtypes.ModuleName:         {authtypes.Minter, authtypes.Burner},
	}
	// Module configurator
...
func New(
	...
	app.ElysiumKeeper = *elysiumkeeper.NewKeeper(
		appCodec,
		keys[elysiumtypes.StoreKey],
		keys[elysiumtypes.MemStoreKey],
		app.BankKeeper,
		app.TransferKeeper,
		gravityKeeper,
		app.EvmKeeper,
	...
	elysiumModule := elysium.NewAppModule(app.ElysiumKeeper, app.AccountKeeper, app.BankKeeper, app.GetSubspace(elysiumtypes.ModuleName))
	...
	govRouter.AddRoute(govtypes.RouterKey, govv1beta1.ProposalHandler).
		...
		AddRoute(elysiumtypes.RouterKey, elysium.NewTokenMappingChangeProposalHandler(app.ElysiumKeeper))
	...
	*/
	...
	transferStack = middleware.NewIBCConversionModule(transferStack, app.ElysiumKeeper)
	...
	if !skipGravity {
		app.GravityKeeper = *gravityKeeper.SetHooks(app.ElysiumKeeper)
		gravitySrv = gravitykeeper.NewMsgServerImpl(app.GravityKeeper)
	}

	app.EvmKeeper.SetHooks(elysiumkeeper.NewLogProcessEvmHook(
		evmhandlers.NewSendToAccountHandler(app.BankKeeper, app.ElysiumKeeper),
		evmhandlers.NewSendToEvmChainHandler(gravitySrv, app.BankKeeper, app.ElysiumKeeper),
		evmhandlers.NewCancelSendToEvmChainHandler(gravitySrv, app.ElysiumKeeper, app.GravityKeeper),
		evmhandlers.NewSendToIbcHandler(app.BankKeeper, app.ElysiumKeeper),
		evmhandlers.NewSendElyToIbcHandler(app.BankKeeper, app.ElysiumKeeper),
		evmhandlers.NewSendToIbcV2Handler(app.BankKeeper, app.ElysiumKeeper),
	))
...
func (app *App) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	...
	options := ante.HandlerOptions{
		...
		ElysiumKeeper: app.ElysiumKeeper,
	}
...
func RegisterSwaggerAPI(ctx client.Context, rtr *mux.Router) {
	statikFS, err := fs.NewWithNamespace("elysium")
	if err != nil {
		panic(err)
	}
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey, skipGravity bool) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(elysiumtypes.ModuleName).WithKeyTable(elysiumtypes.ParamKeyTable())
