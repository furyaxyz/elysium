...
contract ModuleFRC20 is DSToken  {
    // sha256('elysium-evm')[:20]
    address constant module_address = 0x89A7EF2F08B1c018D5Cc88836249b84Dd5392905;
    string denom;

    event __ElysiumSendToEthereum(address recipient, uint256 amount, uint256 bridge_fee);
    ...
    function send_to_ethereum(address recipient, uint amount, uint bridge_fee) external {
        ...
        emit __ElysiumSendToEthereum(recipient, amount, bridge_fee);
    }
