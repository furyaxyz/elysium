...
DEFAULT_GAS_PRICE = "100000000000basetely"
DEFAULT_GAS = "250000"
...
def module_address(name):
    ...
    return bech32.bech32_encode("ely", bech32.convertbits(data, 8, 5))
...
class CosmosCLI:
    ...
    def balance(self, addr, denom="basetely", height=0):
        denoms = {
    ...
    def set_delegate_keys(self, val_addr, acc_addr, eth_addr, signature, **kwargs):
        """
        val_addr: elysium validator address
        acc_addr: orchestrator's elysium address
